...
namespace unmdosx
{
	...
	{
        const string AttackText = "Mulai";
		const string StpFldText = "Stop";
		...
		private void LockOnURL(bool silent = false)
		{
			...
			//		
				...
				{
					lbSize.Text = " Gagal Menghubungkan";
                    lbSize.ForeColor = System.Drawing.Color.Red;
					return;
				}
			}
			catch(Exception ex)
		...
		private void frmMain_Load(object sender, EventArgs e)
		{
            ...
            {
                lbJalan.Text = "Universitas Negeri Makassar Denial of Service";
            }
           
            AcceptButton = cmdAttack;
            chkMsgRandom.Checked = true;
            txtTargetURL.Text = radioButton2.Text;
          ///  LockOnURL(false);
            tJalan.Start();
            this.Text = "UNM-DOS v1";
		}
		...
		private void cmdAttack_Click(object sender, EventArgs e)
		{
            ...
            //string message = Functions.RandomString();
		...
		private void tShowStats_Tick(object sender, EventArgs e)
		{
            ...
            if (int.Parse(lbRequested.Text) * 8 >= 1024)
            {
                lbSize.ForeColor = System.Drawing.Color.Lime;
                lbSize.Text = " Proses: " + Math.Round(((int.Parse(lbRequested.Text) * 8) / 1024.0), 1).ToString()  + " Mb";
            }
                else
                {
                    lbSize.ForeColor = System.Drawing.Color.Lime;
                    lbSize.Text = " Proses: " + ((int.Parse(lbRequested.Text) * 8)).ToString() + " Kb";
                }
        ...
        private void lbRequested_Click(object sender, EventArgs e)
        {
        ...
        {
            txtTargetURL.Text = radioButton3.Text;
           
        }

        private void radioButton4_CheckedChanged(object sender, EventArgs e)
        {
            txtTargetURL.Text = radioButton4.Text;
        ...
        {
            cmdAttack.PerformClick();
        }

        private void tJalan_Tick(object sender, EventArgs e)
        {
            if (lbJalan.Left <= -lbJalan.Width)
            {
                lbJalan.Left = Width;
            }
            else
            {
                lbJalan.Left = lbJalan.Left - 10;
            }
        }

        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start("https://t.me/anonymousunm");
        }
